...
modelname<-"GRAHS4_ind"
GRAHS_model<-GRAHS4_ind<-"
model{
...
# ===========================================================
    ...
    for(y in 1:Nyears){
      for(r in 1:Nrec){
        ...
        for(l in 1:Nlengths[s]){
          zL[l,s,r,y]~dlnorm(ML[l,s,r,y],tauL[l,s,r,y])
        }
      }
    }
  }
  ...
  for(y in 1:Nyears){
    for(r in 1:Nrec){
      muL[1:Nlengths[1],1,r,y]~ddirich(aL1) # Herring
      muL[1:Nlengths[2],2,r,y]~ddirich(aL2) # Sprat
      muL[1:Nlengths[3],3,r,y]~ddirich(aL3) # GTA
      muL[1:Nlengths[4],4,r,y]~ddirich(aL4) # Other
